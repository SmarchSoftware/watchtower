...
It will give you full control over your roles <i class="icon-users"></i>, their permissions<i class="icon-key"></i> and the users<i class="icon-user"></i> that have access to them. You will be able to add, edit, update, delete and synchronize all three as needed. 
...
#### <i class="icon-provider-composer"></i> Composer

    composer require smarch/watchtower

#### <i class="icon-pencil"></i> Service Provider
...
#### <i class="icon-tasks"></i> Database Migrations / Seeds
